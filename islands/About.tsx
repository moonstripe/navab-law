...
export default () => {
    return (
        <div id="about" data-scrollspy="#about" class={tw`lg:grid-cols-5 text-white w-5/6 lg:w-2/3 mx-auto pb-8 lg:mt-8`}>
            <div class={tw`lg:absolute lg:top-[65vh] left-0 w-screen bg-blue-dark h-0 lg:h-[50vh] -z-10`}>
                <div id="about-off" class={tw`relative t-[-100px]`} />
            </div>
            <div class={tw`col-span-5 h-fit lg:h-[45vh] my-auto lg:grid lg:grid-cols-5 lg:grid-rows-2 lg:gap-1 z-50 flex flex-col`}>

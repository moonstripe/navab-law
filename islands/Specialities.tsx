            ...
            <div class={tw`h-[250vh] lg:h-[75vh] z-40 stroke-white flex flex-col`}>
                ...
                <div class={tw`flex flex-col lg:flex-row my-0`}>
                    <button onClick={handleClick} id="0" class={tw`outline-none focus:outline-none mx-auto`}>
                        <h4 id="0" class={ content === 0 ? tw`text-white w-max text-xl mx-auto` : tw`text-blue-light w-max text-xl mx-auto`}>Civil Rights</h4>
                    ...
                    <button onClick={handleClick} id="1" class={tw`outline-none focus:outline-none mx-auto`}>
                        <h4 id="1" class={ content === 1 ? tw`text-white w-max text-xl mx-auto` : tw`text-blue-light w-max text-xl mx-auto`}>Personal Injury</h4>
                    ...
                    <button onClick={handleClick} id="2" class={tw`outline-none focus:outline-none mx-auto`}>
                        <h4 id="2" class={ content === 2 ? tw`text-white w-max text-xl mx-auto` : tw`text-blue-light w-max text-xl mx-auto`}>Employment</h4>
